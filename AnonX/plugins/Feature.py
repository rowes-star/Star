...
@app.on_message(
    command(["مميزات","مميزات سورس ستار"])
 )
async def mmmezat(client, message):
        await message.reply_text(f"""**مرحبآ بك عزيزي » {message.from_user.mention}**في قسم مميزات سورس ستاࢪ ميوزك\n
──── 「 𝙎𝙊𝙐𝙍𝘾𝙀 𝙎𝙏𝘼𝙍 」────

⚝قايمه مميزات سورس ستاࢪ
